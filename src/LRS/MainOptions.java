...
import LRS.Randomly.StringGenerationStrategy;
...
public class MainOptions {
    ...
    @Parameter(names = "--print-progress-summary", description = "Whether to print an execution summary when exiting LRS", arity = 1)
