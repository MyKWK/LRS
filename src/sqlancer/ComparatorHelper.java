...
public final class ComparatorHelper {
    ...
    public static List<List<Object>> getResultSet(
            String queryString,
            ExpectedErrors errors,
...
//        List<String> resultSet = new ArrayList<>();
    ...
    public static boolean compareResultSets(List<List<Object>> resultSet1, List<List<Object>> resultSet2) throws Exception {
        return new HashSet<>(resultSet1).equals(new HashSet<>(resultSet2));
    }

    private static List<List<Object>> resultSetToList(ResultSet resultSet) throws Exception
    {
