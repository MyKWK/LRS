...
public class tester {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/tpcd", "root", "1368");
            ...
            try {
                ...
                if (e instanceof java.sql.SQLSyntaxErrorException) {
                    System.err.println("原始查询错误: " + e.getMessage());
                    return true;
                } else {
                    throw e;
                }
            ...
            try {
                ...
                if (e instanceof java.sql.SQLSyntaxErrorException) {
                    System.err.println("重写查询错误: " + e.getMessage());
                    return true; // 表示由于语法错误而未能比较
                } else {
                    throw e;
                }
            }
    ...
    public static void writeStringToFile(String content) {
        String filePath = "src/sqlancer/mysql/LR/测试结果.txt";
